...
export default function DetailCodeSmellPopup({ labels, onClose, row }) {
  if (!row) {
    return null;
  }

  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/30 px-4" role="dialog" aria-modal="true" aria-label="Detail CodeSmell">
      <div className="w-full max-w-[560px] rounded-[15px] bg-white p-5 shadow-[0_16px_40px_rgba(0,0,0,0.18)]">
        <div className="mb-4 flex items-center justify-between gap-4">
          <h2 className="m-0 text-[18px] font-medium leading-6 text-[#212121]">Detail CodeSmell</h2>
          <button
